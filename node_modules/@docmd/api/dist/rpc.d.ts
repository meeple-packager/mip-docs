 ...
 * --------------------------------------------------------------------
 */
import type { ActionHandler, EventHandler, DispatchResult } from './types.js';
/**
 * Resolve a relative path against the project root, rejecting any path
 * that would escape the root directory.
 */
export declare function safePath(root: string, relativePath: string): string;
 ...
 */
export declare function createActionDispatcher(hooks: DispatcherHooks, options: DispatcherOptions): {
    /**
     * Dispatch a call-style action.  Returns `{ result, reload }`.
     */
    handleCall(action: string, payload: any): Promise<DispatchResult>;
    /**
