...
export declare function copy(src: string, dest: string, retryCount?: number): Promise<void>;
export declare function exists(filePath: string): Promise<boolean>;
export declare const pathExists: typeof exists;
export declare function writeJson(file: string, object: any, options?: any): Promise<void>;
declare const _default: {
    ...
    mkdtempDisposable(prefix: import("fs").PathLike, options?: import("fs").EncodingOption): Promise<fs.DisposableTempDir>;
    ...
    watch(filename: import("fs").PathLike, options?: fs.WatchOptionsWithStringEncoding | BufferEncoding): NodeJS.AsyncIterator<fs.FileChangeInfo<string>>;
    watch(filename: import("fs").PathLike, options: fs.WatchOptionsWithBufferEncoding | "buffer"): NodeJS.AsyncIterator<fs.FileChangeInfo<NonSharedBuffer>>;
    watch(filename: import("fs").PathLike, options: fs.WatchOptions | BufferEncoding | "buffer"): NodeJS.AsyncIterator<fs.FileChangeInfo<string | NonSharedBuffer>>;
