...
async function autoInstallDocmdSearch(tui, quiet) {
    ...
    try {
        ...
        if (!quiet && tui) {
            ...
            tui.warn('  Could not auto-install docmd-search. Please install manually:\n' +
            ...
            console.warn('[plugin-search] Failed to auto-install docmd-search.\n' +
...
export async function onPostBuild({ config, pages, outputDir, tui, options, runWorkerTask }) {
    ...
    if (pluginOptions.semantic === true) {
        ...
        if (!ready) {
            ...
            if (showTui)
                tui.warn('  Falling back to keyword search (docmd-search not installed)');
        }
        else {
            if (showTui)
