 ...
 */
export declare function filterGhostVersions(config: any, CWD: string, isDev: boolean): Promise<void>;
/**
 ...
 */
export declare function filterNavForVersion(items: any[], vSrcDir: string, fallbackSrcDir?: string | null): any[];
/**
 ...
 */
export declare function resolveVersionNav(v: any, vSrcDir: string, configNavigation: any): any;
/**
 ...
 */
export declare function buildVersions({ config, outputDir, hooks, buildHash, options, CWD, pathPrefix, onProgress, targetFiles, coreVersion }: {
    config: any;
    outputDir: string;
    hooks: any;
    buildHash: string;
