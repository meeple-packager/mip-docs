 ...
 */
export declare function isWorkspace(rawConfig: any): rawConfig is WorkspaceRootConfig;
/**
 * Load the raw config file without normalization to check for workspace settings.
 */
export declare function detectWorkspace(configPathOption: string): Promise<WorkspaceRootConfig | null>;
/**
 * Build all projects in a workspace.
 */
export declare function buildWorkspace(workspaceConfig: WorkspaceRootConfig, opts?: {
    isDev?: boolean;
    offline?: boolean;
    quiet?: boolean;
}): Promise<void>;
 ...
 */
export declare function devWorkspace(workspaceConfig: WorkspaceRootConfig, opts?: {
    port?: string;
    preserve?: boolean;
}): Promise<void>;
